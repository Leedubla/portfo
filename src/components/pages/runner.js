...
return (
    <div class="jumbotron">
    <h1 class="display-4">The Runner Game.</h1>
    <p class="lead"> This is the second group project I got the opertunity to work on. 
    ...
    <hr class="my-4"></hr>
    <p>Heroku App</p>
    <a class="btn btn-dark btn-md" href="https://blooming-spire-21723.herokuapp.com/"
        role="button">The Runner Game</a>
        <p>Here is a link to the Repository.</p>
        <a class="btn btn-dark btn-md" href="https://github.com/RandyLofgren/Runner-Game"
